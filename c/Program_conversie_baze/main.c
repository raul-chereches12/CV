...
/*
void calcul_baza();
int calcul_suma_polinom(char baza[20],int b);
int main(){

char baza[20],c;
    int b,rest,catul,n=1,i,p;


printf("Introduceti baza in care vreti sa fie calculat numarul");
scanf("%d",&b);

printf("Introduceti expresia in baza 10");
scanf("%d",&catul);
...
int calcul_suma_polinom(char baza[20],int b){
    int suma=0,p,i;
    p=1;
    for(i=strlen(baza);i<=1;i--){
if(baza[i]>='A'&&baza[i]<='Z')
    suma=suma+baza[i]-'A';
else
    suma=suma+baza[i]-'0';
